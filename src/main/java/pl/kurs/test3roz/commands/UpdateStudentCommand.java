...
public class UpdateStudentCommand extends UpdatePersonCommand {
    ...
    public void applyTo(Person person) {
        if (!(person instanceof Student student)) {
            throw new IllegalArgumentException("Expected Student, got " + person.getClass().getSimpleName());
        }
        student.setCurrentUniversityName(currentUniversityName);
        student.setStudyMajor(studyMajor);
